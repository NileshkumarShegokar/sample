...
public class SeleniumPracticeComponents extends ReusableLibrary {
	...
	public void enterDetails() {
		...
		a.executeScript("arguments[0].scrollIntoView(true);",driver.findElement(SeleniumPracticePage.btnToolUFT));
		driver.findElement(SeleniumPracticePage.btnToolUFT).click();
	    a.executeScript("arguments[0].scrollIntoView()",driver.findElement(SeleniumPracticePage.btnToolProtractor));
		driver.findElement(SeleniumPracticePage.btnToolProtractor).click();
	    a.executeScript("arguments[0].scrollIntoView()",driver.findElement(SeleniumPracticePage.btnToolSelenium));
